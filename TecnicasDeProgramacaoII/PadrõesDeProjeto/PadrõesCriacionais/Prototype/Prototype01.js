...
//adicionando pessoa
manager.adicionaPessoa(1, "Mariana", 21);
manager.adicionaPessoa(2, "Julia", 22);
manager.adicionaPessoa(3, "Silva", 33);

//clonando pessoa e modificando os dados;
const pessoaClone1 = manager.getPessoaById(1);
if (pessoaClone1) {
    pessoaClone1.nome = "Maria";
}

const pessoaClone2 = manager.getPessoaById(2);
if (pessoaClone2) {
    pessoaClone2.idade = 43;
    pessoaClone2.nome = "Ana";
}
